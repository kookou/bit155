...
public class AirPlane {
	private int number;
	private String name;
	private static int total; //모든 객체가 공유하는 자원
	
	//public  AirPlane (){}
	
	
	public AirPlane(int number ,String name) { //당신은 반드시 번호, 이름을 넣어라
		this.number = number;
		this.name = name;
		total ++;
	}
	...
	public static void AirPlanePrint(){
		System.out.printf("현재 비행기의 제작 갯수는 %d개 입니다.",total);
	}
	public void airPlaneInfo(){
		System.out.printf("이 비행기의  번호는 %d, 이고 이름은 %s 입니다.\n",number,name);
	}
